...
class TabletRecentAnalysisPage extends StatefulWidget {
  const TabletRecentAnalysisPage({Key? key}) : super(key: key);

  @override
  State<TabletRecentAnalysisPage> createState() =>
      _TabletRecentBillsPageState();
}

class _TabletRecentBillsPageState extends State<TabletRecentAnalysisPage> {
