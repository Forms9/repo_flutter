...
class TabletUpdatePrice extends StatefulWidget {
  const TabletUpdatePrice({super.key});

  @override
  State<TabletUpdatePrice> createState() => _TabletUpdatePriceState();
}

class _TabletUpdatePriceState extends State<TabletUpdatePrice> {
