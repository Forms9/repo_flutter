...
class TabletScanBarcodePage extends StatefulWidget {
  ...
  @override
  State<TabletScanBarcodePage> createState() => _TabletScanBarcodePageState();
}

class _TabletScanBarcodePageState extends State<TabletScanBarcodePage> {
                  ...
                  SizedBox(
                    ...
                    child: MobileScanner(
                      ...
                      onDetect: (capture) {
                        ...
                        for (final barcode1 in barcodes) {
                          debugPrint('Barcode found! ${barcode1.rawValue}');
                          barcode = barcode1.rawValue!;
                        }
                        log(
                          barcode.toString(),
                        );
